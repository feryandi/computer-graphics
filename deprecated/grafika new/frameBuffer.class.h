...
class frameBuffer {
	...
	public:
		...
		void bresenham(int x1, int y1, int x2, int y2, int pixel, int red, int green, int blue, int** oosMap);		
		void solidFill(int xs, int ys, int xe, int ye, int r, int g, int b) ;
